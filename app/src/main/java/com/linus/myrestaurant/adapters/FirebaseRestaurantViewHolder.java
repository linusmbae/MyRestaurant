package com.linus.myrestaurant.adapters;
...
import com.linus.myrestaurant.ui.RestaurantDetailActivity;
...
public class FirebaseRestaurantViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference().child(Constants.FIREBASE_CHILD_RESTAURANTS).child("M93LgnQQ3kWMQbJ-iFL");
